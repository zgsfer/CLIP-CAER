...
##### 包含上下文
class_descriptor_5 = [
'Neutral eyebrows, open eyes, relaxed mouth, engaged with study materials, no noticeable emotional changes, or natural body posture.',

'Upturned mouth corners, relaxed eyebrows,sparkling eyes, focused on course content,or occasionally nodding in agreement.',

'Slightly open mouth, wandering or puzzled gaze, chin rests on the palm, furrowed eyebrows, or eyes lock on learning material.',

'Mouth opens in a yawn, eyelids droop, eyes lock on learning material, head tilts forward, or hand writing.',

'Shifting eyes, relaxed but unfocused expression, restless or fidgety posture, averted gaze from study materials, or frequently checking phone.'
]